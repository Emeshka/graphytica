...
exec "$JAVA" $JAVA_OPTS \
    ...
    -Dorientdb.build.number="3.1.x@rbc7b3fe5b4a2f6b20648c7b81def7dc3f299cfff; 2020-10-20 10:18:23+0000" \
    -cp "$ORIENTDB_HOME/lib/orientdb-server-3.1.4.jar:$ORIENTDB_HOME/lib/*:$ORIENTDB_HOME/plugins/*" \
